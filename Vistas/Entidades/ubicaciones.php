...
<img src="../../imagenes/ubicaciones.png"><br><br>
 ...
 <?php
  echo "<div id='agregar'>
            <form  method='post' action='../Agregar/agregarubicacion.php'><img src='../../imagenes/add.gif' class='icon'>
                <input type='submit' value='Agregar Ubicación'  name='agregar' class='conf'>
            </form>
        </div>";
 echo"<br><br>";
    echo "<div>";
