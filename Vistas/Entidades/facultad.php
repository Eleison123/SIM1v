...
<nav id="menu">
    <ul>
        ...
        <li><a href="facultad.php" id="qwerty">FACULTAD</a></li>
...
<img src="../../imagenes/facultad.png">
 ...
 <?php
  echo "<div id='agregar'><form  method='post' action='../Agregar/agregarfacultad.php'><img src='../../imagenes/add.gif' class='icon'>
                        <input type='submit' value='Agregar Facultad'  name='agregar' class='conf'>
                        </form></div>";
 echo"
