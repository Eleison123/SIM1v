...
<title>Horarios Intersemestral</title>
</head>
<!--///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////-->
<!--                                        Inicia Menu                                                                                -->
<!--///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////-->
...
<div id="cuerpo">
<figure id="figura">
<img src="imagenes/horariointersemestral.png">
</figure>

 
 <?php
  echo "<div id='agregar'><form  method='post' action='agregarhinter.php'><img src='imagenes/add.gif' class='icon'>
 ...
 //Preguntamos quien es el administrador para obtener la "idfacultad"
    ...
    //Preguntamos los nombres de las materias segun su idfacultad
     require_once("conexiones/conexion.php");
                @session_start();
                         ...
                         $mysqlfacu="SELECT * FROM horariointersemestral WHERE idfacultad=".$fac.";";
    ...
    $tamano_pag = 10;
        ...
        if (isset($_GET["pagina"]))
                        ...
                        ///realizamos consulta
                        require_once('conexiones/conexion.php');
                        $consultas="SELECT idhorariointersemestral, idcatedratico, idcarrera,idfecha,idmateria FROM horariointersemestral WHERE idfacultad=".$fac." ORDER BY idcarrera DESC LIMIT ".$inicio.",".$tamano_pag;
...
echo "<td><a class='text10'>".$fe['dia']."</a></td> ";
 ...
 <form  method='post' action='modificar/editarhinter.php'>
    <input type='hidden' name='idhinter' value=".$row1['idhorariointersemestral'].">
    <input type='submit' value='Editar'  name='Editar' class='conf'><img src='imagenes/editar.png' class='icon'>
     </form>
</td>";
                        echo "<td>
    <form  method='post' action='eliminarhorariointer.php'>
    <input type='hidden' name='idhinter' value=".$row1['idhorariointersemestral'].">
