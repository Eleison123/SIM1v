...
<title>Modificar Horario Exámenes</title>
</head>
<!--///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////-->
<!--                                        Inicia Menu                                                                                -->
<!--///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////-->
...
<img src="imagenes/separador.png">
 ...
 <h1>Modificar Horario Exámenes</h1>
 <?php
 
 echo"<form name='modhex' method='post' action='modificar/editarhexa.php'>";
     ...
     require_once("conexiones/conexion.php");
                @session_start();
                        ...
                        while($row1=mysql_fetch_array($resulf)){
                            ...
                            echo "<table>";
                             echo "<a class='text2'>".$row1['nombre']."</a>"; 
                            echo"<tr><td><a class='text1'>Selección</a></td>
                            <td><a class='text1'>Materia</a></td>
                            <td><a class='text1'>Catedrático</a></td><tr>";
                        
                            require_once("conexiones/conexion.php");
                            $mysql="select idhorarioexamen, idmateria, idcatedratico, idcarrera from horarioexamenes where idcarrera='".$row1['idcarrera']."';";
                            $resul=mysql_query($mysql) or die(mysql_error());
                                while($row=mysql_fetch_array($resul)){ 
                                    echo "<tr>";
                                    echo"<td><input type='radio' value='".$row['idhorarioexamen']."' name='idhexa' id='radio' ></td>";
...
<input type='submit' value='Editar' name='Editar' id="btnguardar">
</form>
<figure>
<img src="imagenes/separador.png">
</figure>
