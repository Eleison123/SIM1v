...
<img src="imagenes/separador.png">
 ...
 <fieldset><legend><a class="text2">Usuarios Disponibles.</a></legend>
 <?php
 
 echo"<form name='moduser' method='post' action='modificar/editarusuario.php'>";
     ...
     require_once("conexiones/conexion.php");
                @session_start();
                         ...
                         echo"<tr>";
                            ...
                            <td><a class='text1'>Administrador</a></td>
                            <td><a class='text1'>Contraseña</a></td>
                            </tr>";
                            //Preguntamos los nombres de las carreras segun su idfacultad
                         $mysqlfacu="SELECT idadministrador, nombre FROM administrador where idfacultad = '".$fac."'; ";
                        $resulf=mysql_query($mysqlfacu) or die(mysql_error());
                        while($row1=mysql_fetch_array($resulf)){
                                   echo "<tr>";
                                    echo"<td><input type='radio' value='".$row1['idadministrador']."' name='idad' id='radio' ></td>";
                                   
                                 
                                      echo "<td><a class='text1'>".$row1['nombre']."</a></td>";
                                      echo " ";
                                  
                                        echo "<td><a class='text1'>*******</a></td>";
