...
<img src="imagenes/separador.png">
 ...
 <fieldset><legend><a class="text1">Carreras Disponibles</a></legend>
 <?php
 
 echo"<form name='modcar' method='post' action='modificar/editarcarrera.php'>";
     ...
     require_once("conexiones/conexion.php");
                @session_start();
                         ...
                         echo"<tr>";
                            ...
                            <td><a class='text1'>Carrera</a></td>
                            </tr>";
                            //Preguntamos los nombres de las carreras segun su idfacultad
                         $mysqlfacu="SELECT idcarrera, nombre FROM carrera WHERE idfacultad=".$fac." ";
                        $resulf=mysql_query($mysqlfacu) or die(mysql_error());
                        while($row1=mysql_fetch_array($resulf)){
                                   echo "<tr>";
                                    echo"<td><input type='radio' value='".$row1['idcarrera']."' name='idcar' id='radio' ></td>";
