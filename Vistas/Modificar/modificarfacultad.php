...
<title>Modificar Facultad</title>
</head>
<!--///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////-->
<!--                                        Inicia Menu                                                                                -->
<!--///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////-->
...
<img src="imagenes/separador.png">
 ...
 <fieldset><legend><a class="text2">Facultades Disponibles.</a></legend>
 <?php
 
 echo"<form name='modfac' method='post' action='modificar/editarfacultad.php'>";
     ...
     require_once("conexiones/conexion.php");
                @session_start();
                         ...
                         echo"<tr>";
                            ...
                            <td><a class='text1'>Facultad</a></td>
                            <td><a class='text1'>Sede</a></td>
                            </tr>";
                            //Preguntamos los nombres de las carreras segun su idfacultad
                         $mysqlfacu="SELECT idfacultad, nombre, sede FROM facultad ";
                        $resulf=mysql_query($mysqlfacu) or die(mysql_error());
                        while($row1=mysql_fetch_array($resulf)){
                                   echo "<tr>";
                                    echo"<td><input type='radio' value='".$row1['idfacultad']."' name='idfac' id='radio' ></td>";
                                   
                                 
                                      echo "<td><a class='text1'>".$row1['nombre']."</a></td>";
                                      echo " ";
                                  
                                        echo "<td><a class='text1'>".$row1['sede']."</a></td>";
