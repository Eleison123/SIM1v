...
<title>Modificar Horario Examenes</title>
</head>
<!--///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////-->
<!--                                        Inicia Menu                                                                                -->
<!--///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////-->
...
<img src="imagenes/separador.png">
 ...
 <h1>Modificar Horario Escolar</h1>
 <?php
 
 echo"<form name='modhes' method='post' action='modificar/editarhe.php'>";
                ...
                @session_start();
                        ...
                        while($row1=mysql_fetch_array($resulf)){
                         ...
                         echo"<tr>";
                            ...
                            require_once("conexiones/conexion.php");
                            $mysql="select idhorarioescolar, idmateria, idcatedratico, idcarrera from horarioescolar where idcarrera='".$row1['idcarrera']."';";
                            $resul=mysql_query($mysql) or die(mysql_error());
                           
                                while($row=mysql_fetch_array($resul)){ 
                                   echo "<tr>";
                                    echo"<td><input type='radio' value='".$row['idhorarioescolar']."' name='idhes' id='radio' ></td>";
